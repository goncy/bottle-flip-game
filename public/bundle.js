...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(/*! /Users/gonzalo/Documents/projects/phaser/src/main.js */298);
	...
	var _class = function (_Phaser$State) {
	  ...
	  _createClass(_class, [{
	    ...
	    value: function preload() {
	      ...
	      var text = this.add.text(this.world.centerX, this.world.centerY, 'CARGANDO', { font: '26px Arial', fill: '#1B6795', align: 'center' });
...
/***/ function(module, exports) {
	...
	var between = exports.between = function between(x, min, max) {
	  return x >= min && x <= max;
	};

	var bottleInRange = exports.bottleInRange = function bottleInRange(angle) {
	...
	var bottleInRangeSoft = exports.bottleInRangeSoft = function bottleInRangeSoft(angle) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Bottle = __webpack_require__(/*! ../sprites/Bottle */ 310);
	  ...
	  _createClass(_class, [{
	    ...
	    value: function create() {
	      this.bottle = new _Bottle2.default({
	        ...
	        event: {
	          time: _phaser2.default.Timer.SECOND * 1.25,
	    ...
	    key: 'checkBottlePosition',
	    value: function checkBottlePosition() {
	      var _this2 = this;

	      if ((0, _utils.bottleInRangeSoft)(this.bottle.angle)) {
	        setTimeout(function () {
	          if ((0, _utils.bottleInRange)(_this2.bottle.angle)) return _this2.checkIfNotAlreadyWon();
	        }, 500);
	      }
	    }
	  }, {
	    key: 'checkIfNotAlreadyWon',
	    value: function checkIfNotAlreadyWon() {
	      if (!this.hasWon) return this.checkIfNotFirstTime();
	    }
	  }, {
	    key: 'checkIfNotFirstTime',
	    value: function checkIfNotFirstTime() {
	      if (!this.firstTime) this.checkIfBottleSpun();else return this.firstTime = false; //eslint-disable-line
	    }
	  }, {
	    key: 'checkIfBottleSpun',
	    value: function checkIfBottleSpun() {
	      if (this.bottle.hasSpun()) return this.checkWonState();else return this.showMessage('La botella debe girar por lo menos una vuelta');
	    }
	  }, {
	    key: 'checkWonState',
	    value: function checkWonState() {
	      var winPositionNumber = (0, _utils.bottleInRange)(this.bottle.angle);
	      if (winPositionNumber === 1) return this.winnerMessage('Ganaste');else if (winPositionNumber === 2) return this.winnerMessage('WTFFFFF, re ganaste');
	    }
	  }, {
	    key: 'winnerMessage',
	    value: function winnerMessage(message) {
	      var _this3 = this;
	      ...
	      this.winnerMessageTimer = this.game.time.events.add(_phaser2.default.Timer.SECOND * 5, function () {
	        emitter.destroy();
	        _this3.winnerMessageText.destroy();
	        _this3.game.time.events.remove(_this3.winnerMessageTimer);
	        _this3.hasWon = false;
	      }, this);
	    }
	  }, {
	    ...
	    value: function showMessage(message) {
	      ...
	      this.messageTimer = this.game.time.events.add(_phaser2.default.Timer.SECOND * 7, function () {
	        _this4.messageText.destroy();
	        _this4.messageText = null;
	        _this4.game.time.events.remove(_this4.messageTimer);
	      }, this);
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _p = __webpack_require__(/*! p2 */ 301);
	...
	var BOTTLE_SPIN_ROTATION = 6.293246930743587;
	...
	var _class = function (_Phaser$Sprite) {
	  ...
	  function _class(_ref) {
	    var game = _ref.game,
	        ...
	        asset = _ref$asset === undefined ? 'bottle' : _ref$asset,
	        event = _ref.event;
	    ...
	    _this.body.loadPolygon('physicsData', 'bottle');

	    _this.body.collideWorldBounds = true;

	    _this.mouseBody = new _p2.default.Body(_this.game, _this);
	    _this.game.physics.p2.world.addBody(_this.mouseBody);

	    _this.game.input.onDown.add(_this.click, _this);
	    _this.game.input.onUp.add(_this.release, _this);
	    _this.game.input.addMoveCallback(_this.move, _this);

	    _this.body.onBeginContact.add(_this.blockHit, _this);
	    _this.body.onEndContact.add(_this.blockLeave, _this);

	    _this.click = _this.click.bind(_this);
	    _this.release = _this.release.bind(_this);
	    _this.move = _this.move.bind(_this);
	    _this.blockHit = _this.blockHit.bind(_this);
	    _this.blockLeave = _this.blockLeave.bind(_this);
	  ...
	  _createClass(_class, [{
	    ...
	    key: 'blockHit',
	    value: function blockHit(body, shapeA, shapeB, equation) {
	      this.winTime = this.game.time.events.add(this.event.time, this.event.callback, this);
	    }
	  }, {
	    key: 'blockLeave',
	    value: function blockLeave(body, shapeA, shapeB, equation) {
	      this.game.time.events.remove(this.winTime);
	    }
	  }, {
	    key: 'hasSpun',
	    value: function hasSpun() {
	      var spinDifference = this.releaseRotation / BOTTLE_SPIN_ROTATION - this.rotation / BOTTLE_SPIN_ROTATION;
